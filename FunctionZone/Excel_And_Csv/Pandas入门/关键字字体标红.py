...
if __name__ == '__main__':
    data = pd.read_excel(r'../../../EthanFileData/g1_data.xlsx')  # 原文本文件
    data_result = Workbook(r'../../../EthanFileData/g1_data-result.xlsx')  # 标注结果
    cate_data = pd.read_excel(r'../../../EthanFileData/g1_cate_data.xlsx')  # 匹配的文本文件
